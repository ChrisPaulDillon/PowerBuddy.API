...
namespace PowerBuddy.MediatR.ProgramLogs.Commands
{
    ...
    internal class UpdateProgramLogCommandValidator : AbstractValidator<UpdateProgramLogCommand>
    {
    ...
    internal class UpdateProgramLogCommandHandler : IRequestHandler<UpdateProgramLogCommand, bool>
    {
