...
namespace PowerBuddy.MediatR.ProgramLogs.Commands
{
    ...
    internal class DeleteProgramLogCommandValidator : AbstractValidator<DeleteProgramLogCommand>
    {
    ...
    internal class DeleteProgramLogCommandHandler : IRequestHandler<DeleteProgramLogCommand, bool>
    {
