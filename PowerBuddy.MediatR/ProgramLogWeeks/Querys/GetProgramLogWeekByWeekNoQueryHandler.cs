...
namespace PowerBuddy.MediatR.ProgramLogWeeks.Querys
{
    ...
    internal class GetProgramLogWeekByWeekNoQueryValidator : AbstractValidator<GetProgramLogWeekByWeekNoQuery>
    {
    ...
    internal class GetProgramLogWeekByWeekNoQueryHandler : IRequestHandler<GetProgramLogWeekByWeekNoQuery, ProgramLogWeekExtendedDTO>
    {
