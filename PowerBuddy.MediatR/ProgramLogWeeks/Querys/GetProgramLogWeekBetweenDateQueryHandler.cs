...
namespace PowerBuddy.MediatR.ProgramLogWeeks.Querys
{
    ...
    internal class GetProgramLogWeekBetweenDateQueryValidator : AbstractValidator<GetProgramLogWeekBetweenDateQuery>
    {
    ...
    internal class GetProgramLogWeekBetweenDateQueryHandler : IRequestHandler<GetProgramLogWeekBetweenDateQuery, ProgramLogWeekExtendedDTO>
    {
