...
namespace PowerLifting.Data.SeedData.TemplatePrograms
{
    public static class TemplateProgramSeed
    {
        ...
        {
            var squat = exercises.Where(x => x.ExerciseName == "Back Squat").Select(x => x.ExerciseId).FirstOrDefault();
            var bench = exercises.Where(x => x.ExerciseName == "Bench Press").Select(x => x.ExerciseId).FirstOrDefault();
            var deadlift = exercises.Where(x => x.ExerciseName == "DeadLift").Select(x => x.ExerciseId).FirstOrDefault();
            var row = exercises.Where(x => x.ExerciseName == "Barbell Row").Select(x => x.ExerciseId).FirstOrDefault();
            var overheadPress = exercises.Where(x => x.ExerciseName == "Overhead Press").Select(x => x.ExerciseId).FirstOrDefault();
