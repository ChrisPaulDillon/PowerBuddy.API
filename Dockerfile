...
COPY ["PowerLifting.Contracts/PowerLifting.Contracts.csproj", "PowerLifting.Contracts/"]
COPY ["PowerLifting.Entities/PowerLifting.Entities.csproj", "PowerLifting.Entities/"]
